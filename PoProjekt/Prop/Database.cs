...
namespace Database
{
     ...
     public class Database
        {
            static private SQLiteConnection databaseConnection = new SQLiteConnection(
        ...
        static private bool CheckCityTable(string city)
            ...
            and entry_day ='{System.DateTime.Now.DayOfYear}'", 1)[0][0]);
            ...
            'current', '{objectID}', '{++order}')");
                ...
                {
                    ExecuteInsertQuery($@"Insert into weather (time_recorded, summary, temperature_celsius, humidity, pressure_hPa, 
                wind_speed,  type_of_forecast, id_object, list_order) values ('{element.time}', '{element.summary}',
